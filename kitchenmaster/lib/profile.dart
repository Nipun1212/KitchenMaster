      ...
      backgroundColor: Color(0xffe5e5e5),
        body: Center(
            child: Column(
                ...
                children: <Widget>[
                  Text('Hello, Grace!', textAlign: TextAlign.center,
                      style: TextStyle(
                  ...
                  Container(
                      ...
                      child: Column(children: <Widget>[
                              ...
                              Expanded(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  border: OutlineInputBorder(
                                    borderSide:BorderSide(width: 3, color: Colors.black54), //<-- SEE HERE
                                    borderRadius: BorderRadius.circular(50.0),),
                                  focusedBorder: OutlineInputBorder(
                                    borderSide:BorderSide(width: 3, color: Color(0xffff6961)), //<-- SEE HERE
                                    borderRadius: BorderRadius.circular(50.0),),
                                ),
                              )),
                          ]
                        ...
                        TextButton(
                            style: ButtonStyle(
                              side: MaterialStateProperty.all<BorderSide>(BorderSide(width: 1.5, color: Colors.black54)),
                              fixedSize: MaterialStateProperty.all<Size>(Size.fromWidth(160.0)),
                              backgroundColor: MaterialStateProperty.all<Color>(Color(0xffff6961)),
                        ...
                        Row(children: [
                          ...
                          ElevatedButton(onPressed: (){},
                            ...
                            child: Row(
                              children: <Widget>[
                                Text("Log Out", selectionColor: Color(0xffff6961), style: TextStyle(fontSize: 15, fontFamily: 'IM FELL English SC'),),
                                SizedBox(width: 5,),
                                Icon(Icons.logout, color: Color(0xffff6961),),
                              ],))]
                        ),
                        SizedBox(height: 30,),
                        Container(
                          ...
                          child: Column(children: <Widget>[
                            Expanded(child:Text("Contact Us",style: TextStyle(fontSize: 15, fontFamily: 'Iceland'))),
